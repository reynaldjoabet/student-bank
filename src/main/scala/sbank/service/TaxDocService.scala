...
/**
  * Tax-document management. Documents themselves live in blob storage; the row in `tax_documents`
  * just carries a [[BlobRef]]. The mobile app downloads via a short-lived signed URL — the actual
  * PDF is then cached on-device for the "available offline" requirement.
  */
